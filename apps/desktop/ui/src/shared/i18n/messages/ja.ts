...
export const ja = defineLocalizedCatalog<'ja', EnglishCatalog>()({
  ...
  'gameDetails.renodx.engineConfigApplyError': 'Engine.ini の設定を適用できませんでした',
  ...
  'gameDetails.renodx.dlssFixRecoveryPending': '以前の DLSS-Fix 操作を復旧する必要があります。',
  ...
  'gameDetails.luma.engineConfigApplyError': 'Engine.ini の設定を適用できませんでした',
  ...
  'gameDetails.renodx.guidance.gameSetting': 'ゲーム内メニューで設定',
  'gameDetails.renodx.guidance.addonSetting': 'RenoDXオーバーレイで設定',
  'gameDetails.renodx.guidance.engineIni': '手動 INI 変更',
  'gameDetails.renodx.guidance.warning': '重要',
  'gameDetails.renodx.guidance.compatibility': '互換性に関する注意',
  'gameDetails.renodx.guidance.externalTool': 'サードパーティーツール',
  'gameDetails.renodx.guidance.copy': 'コピー',
  'gameDetails.renodx.guidance.copied': 'コピーしました',
  'gameDetails.renodx.guidance.copyFailed': 'コピーできませんでした',
  'gameDetails.renodx.guidance.openLink': 'リンクを開く',
  'gameDetails.luma.guidance.gameSetting': 'ゲーム内設定',
  'gameDetails.luma.guidance.engineIni': '手動 INI 変更',
  'gameDetails.engineConfig.title': 'Engine.ini の設定',
  'gameDetails.engineConfig.status.manualOnly': '自動適用は利用できません。',
  'gameDetails.engineConfig.status.pendingFirstLaunch':
    'ゲームを一度起動してから更新し、設定フォルダーを検出してください。',
  'gameDetails.engineConfig.status.ready': 'Engine.ini の設定を適用できます。',
  'gameDetails.engineConfig.status.configured': 'Engine.ini の設定が適用されています。',
  'gameDetails.engineConfig.status.needsRepair':
    '管理対象外でファイルが変更されています。再適用する前に確認してください。',
  'gameDetails.engineConfig.status.conflict':
    '複数の設定場所または競合する値があります。確認してください。',
  'gameDetails.engineConfig.status.recoveryRequired':
    '以前の Engine.ini 変更の復旧が必要です。再適用して再試行してください。',
  'gameDetails.engineConfig.action.apply': 'Engine.ini の設定を適用',
  'gameDetails.engineConfig.action.check': '確認',
  'gameDetails.engineConfig.action.checking': '確認中…',
  'gameDetails.engineConfig.action.manual': '手動で設定',
  'gameDetails.engineConfig.dialog.title': 'Engine.ini の手動設定',

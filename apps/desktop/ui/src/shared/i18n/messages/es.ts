...
export const es = defineLocalizedCatalog<'es', EnglishCatalog>()({
  ...
  'gameDetails.renodx.engineConfigApplyError': 'No se pudo aplicar la configuración de Engine.ini',
  ...
  'gameDetails.luma.engineConfigApplyError': 'No se pudo aplicar la configuración de Engine.ini',
  ...
  'gameDetails.renodx.guidance.gameSetting': 'Configurar en el menú del juego',
  'gameDetails.renodx.guidance.addonSetting': 'Configurar en la superposición de RenoDX',
  'gameDetails.renodx.guidance.engineIni': 'Cambio manual de INI',
  'gameDetails.renodx.guidance.warning': 'Importante',
  'gameDetails.renodx.guidance.compatibility': 'Nota de compatibilidad',
  'gameDetails.renodx.guidance.externalTool': 'Herramienta de terceros',
  'gameDetails.renodx.guidance.copy': 'Copiar',
  'gameDetails.renodx.guidance.copied': 'Copiado',
  'gameDetails.renodx.guidance.copyFailed': 'No se pudo copiar',
  'gameDetails.renodx.guidance.openLink': 'Abrir enlace',
  'gameDetails.luma.guidance.gameSetting': 'Ajuste del juego',
  'gameDetails.luma.guidance.engineIni': 'Cambio manual de INI',
  'gameDetails.engineConfig.title': 'Configuración de Engine.ini',
  'gameDetails.engineConfig.status.manualOnly': 'La aplicación automática no está disponible.',
  'gameDetails.engineConfig.status.pendingFirstLaunch':
    'Inicia el juego una vez y actualiza para detectar su carpeta de configuración.',
  'gameDetails.engineConfig.status.ready':
    'La configuración de Engine.ini está lista para aplicarse.',
  'gameDetails.engineConfig.status.configured': 'La configuración de Engine.ini está aplicada.',
  'gameDetails.engineConfig.status.needsRepair':
    'El archivo cambió fuera de la configuración gestionada. Revísalo antes de aplicarlo de nuevo.',
  'gameDetails.engineConfig.status.conflict':
    'Hay varias ubicaciones o valores de configuración en conflicto. Revísalos.',
  'gameDetails.engineConfig.status.recoveryRequired':
    'Un cambio anterior de Engine.ini requiere recuperación. Vuelve a aplicarlo para reintentarlo.',
  'gameDetails.engineConfig.action.apply': 'Aplicar configuración de Engine.ini',
  'gameDetails.engineConfig.action.check': 'Comprobar',
  'gameDetails.engineConfig.action.checking': 'Comprobando…',
  'gameDetails.engineConfig.action.manual': 'Configurar manualmente',
  'gameDetails.engineConfig.dialog.title': 'Configuración manual de Engine.ini',

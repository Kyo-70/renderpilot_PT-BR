...
- [RenoDX, Luma, and OptiScaler](user/addons.md) covers third-party add-ons, dependencies, compatibility, updates, and removal.
...
- [Localization](development/localization.md) covers locale packs, generated contracts, editorial policy, and Luma/OptiScaler/NVAPI review.

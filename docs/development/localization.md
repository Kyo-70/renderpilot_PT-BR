...
The current external review set contains 410 rows: 89 Luma messages, 151 OptiScaler messages, and 170 NVAPI messages. Repeat review for all eight non-English locales after relevant source changes. A clean generated report and passing automated checks establish structural consistency; they do not constitute native-language approval.

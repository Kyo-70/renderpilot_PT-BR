...
//! ```text
//! update()
//!   ├─ consume the guarded phase-one inactive snapshot
...
use super::{UpdateRequest, route::InactiveUpdatePhase1};
...
pub(super) async fn update(
    ...
    topology::ensure_absent(context, game_id)?;

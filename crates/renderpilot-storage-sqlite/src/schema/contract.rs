...
pub(super) const REQUIRED_INDEXES: &[&str] = &[
    ...
    "idx_game_proxy_topologies_updated_at",
    "idx_optiscaler_install_states_topology",
...
pub(super) const REQUIRED_TRIGGERS: &[&str] = &[
    ...
    "trg_game_proxy_topologies_touch_updated_at",
    "trg_optiscaler_install_states_touch_updated_at",
    "trg_optiscaler_install_states_freeze_configuration_baseline",
    ...
    "trg_pending_shared_vulkan_mutations_freeze_aggregate_binding",
    "trg_peer_aggregate_reservations_freeze_identity",
...
pub(super) const CONSOLIDATION_POLICIES: &[(&str, &str)] = &[
    ...
    ("game_proxy_topologies", "atomic_optiscaler_aggregate"),
    ("optiscaler_install_states", "atomic_optiscaler_aggregate"),
    (
        "pending_shared_vulkan_mutations",
        "recover_before_consolidation",
    ),

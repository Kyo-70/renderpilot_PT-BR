...
pub use addon::{
    ...
    Endpoint, ExactOptiConfigProjection, ExpectedAfter, FileOwnership, FileReceipt,
    GameProxyTopology, InstalledAddon, InstalledAddonHostKind, InstalledAddonInvariantError,
    InstalledAddonParts, LumaInstallState, ManagedAddonFile, ManagedFileBaseline, ManagedFileMode,
    MaterializationState, NamespaceCapability, OperationEffect, OperationEndpoint, OperationRecord,
    OptiConfigOperation, OptiScalerAdoptionState, OptiScalerCleanupLifecycle,
    OptiScalerConfigAuthority, OptiScalerConfigCapability, OptiScalerConfigurationBaseline,
    ...
    OptiScalerJournal, OptiScalerJournalError, OptiScalerJournalKind,
    OptiScalerModuleRuntimeBinding, OptiScalerPrerequisiteBinding, OptiScalerReleaseFileBaseline,
    OptiScalerStateError, OptiScalerTransitionDirection, PeerCatalogDeletedBaseline,
    ...
    PeerTransitionContract, PeerTransitionError, PlannedGameProxyTopology, Preimage,
    PrivateArtifactSlots, PrivateWorkspaceBinding, ProxyImplementation, ProxyLink, ProxyPeerRoute,
    ProxyRootPrestate, ProxyTopologyError, RENODX_DLSS_FIX_INSTALL, RENODX_DLSS_FIX_UNINSTALL,
    RENODX_DLSS_FIX_UPDATE, RENODX_INSTALL, RENODX_INSTALL_FROM_FILE, RENODX_UNINSTALL,
    RelocateEffect, RelocateState, RemoveDirectoryEffect, RemoveDirectoryState,
    RenoDxDlssBeforeImage, RenoDxDlssClaim, RenoDxDlssProjection, RenoDxHostKind,
    RenoDxInstallState, RenoDxReshadeIniAuthority, RenoDxReshadeIniFeature, SharedArtifactKind,
    ...
    from_new_install, from_persisted, managed_sidecar_path, required_read_guards,

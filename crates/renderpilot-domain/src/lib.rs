...
pub use addon::{
    ...
    RenoDxConfigEntry, RenoDxConfigReceipt, RenoDxDlssBeforeImage, RenoDxDlssClaim,
    RenoDxDlssProjection, RenoDxHostKind, RenoDxInstallState, RenoDxManagedBaseline,
    RenoDxManagedConfigKey, RenoDxReshadeIniAuthority, RenoDxReshadeIniFeature,
